...
// palette, fonts, shadows, fluid type/spacing scale. Content glob updated
// for the App Router structure (this is the fix for the old purge bug,
// applied from the start this time instead of bolted on later).
const config: Config = {
  content: [
